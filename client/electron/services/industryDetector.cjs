...
const INDUSTRY_CONFIG = {
  ...
  operation_service: {
    name: '运维服务',
    description: 'IT 运维、设备维保、驻场服务、平台运营和综合保障服务等',
    keywords: ['运维', '维护', '维保', '驻场', '巡检', '故障处理', '服务台', 'SLA', '应急响应', '运营服务'], 
    chapter_structure: [
      '项目理解与服务目标',
      '运维服务总体方案',
      '服务组织与人员配置',
    ...
    key_sections: {
      '运维服务总体方案': ['服务范围', '服务目录', '服务流程', '服务边界'], 
      '服务组织与人员配置': ['组织架构', '岗位职责', '驻场安排', '沟通机制'], 
      '巡检维护与故障处理': ['巡检计划', '故障分级', '处理流程', '闭环记录'], 
      '服务质量与 SLA 管理': ['响应时限', '解决时限', '考核指标', '改进机制'], 
      '应急响应与风险控制': ['应急预案', '升级机制', '备件保障', '重大故障复盘'], 
    },
  },
  government_procurement: {
    name: '政府采购',
    description: '政府采购、事业单位采购、公共服务采购和综合采购项目等',
    keywords: ['政府采购', '采购人', '采购需求', '评分办法', '磋商', '谈判', '询价', '公开招标', '政采', '中小企业'], 
    chapter_structure: [
      '项目理解与采购需求响应',
      '技术服务方案',
      '实施组织与进度计划',
    ...
    key_sections: {
      '采购需求响应': ['需求逐项响应', '偏离说明', '服务边界', '验收要求'], 
      '技术服务方案': ['总体方案', '实施路径', '服务标准', '成果交付'], 
      '履约管理': ['进度控制', '质量控制', '沟通汇报', '资料归档'], 
      '政策响应': ['中小企业政策', '节能环保', '国产化适配', '合规承诺'], 
    },
  },
  general: {
    name: '通用行业',
